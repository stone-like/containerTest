...
class PairStringString(_object):
    ...
    def __init__(self, *args):
        this = _conf.new_PairStringString(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_setmethods__["first"] = _conf.PairStringString_first_set
    __swig_getmethods__["first"] = _conf.PairStringString_first_get
    if _newclass:
        first = _swig_property(_conf.PairStringString_first_get, _conf.PairStringString_first_set)
    __swig_setmethods__["second"] = _conf.PairStringString_second_set
    __swig_getmethods__["second"] = _conf.PairStringString_second_get
    if _newclass:
        second = _swig_property(_conf.PairStringString_second_get, _conf.PairStringString_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _conf.delete_PairStringString
    __del__ = lambda self: None
PairStringString_swigregister = _conf.PairStringString_swigregister
...
class MapStringString(_object):
    ...
    def iterator(self):
        return _conf.MapStringString_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _conf.MapStringString___nonzero__(self)

    def __bool__(self):
        return _conf.MapStringString___bool__(self)

    def __len__(self):
        return _conf.MapStringString___len__(self)
    def __iter__(self):
    ...
    def __getitem__(self, key):
        return _conf.MapStringString___getitem__(self, key)

    def __delitem__(self, key):
        return _conf.MapStringString___delitem__(self, key)

    def has_key(self, key):
        return _conf.MapStringString_has_key(self, key)

    def keys(self):
        return _conf.MapStringString_keys(self)

    def values(self):
        return _conf.MapStringString_values(self)

    def items(self):
        return _conf.MapStringString_items(self)

    def __contains__(self, key):
        return _conf.MapStringString___contains__(self, key)

    def key_iterator(self):
        return _conf.MapStringString_key_iterator(self)

    def value_iterator(self):
        return _conf.MapStringString_value_iterator(self)

    def __setitem__(self, *args):
        return _conf.MapStringString___setitem__(self, *args)

    def asdict(self):
        return _conf.MapStringString_asdict(self)

    def __init__(self, *args):
        this = _conf.new_MapStringString(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def empty(self):
        return _conf.MapStringString_empty(self)

    def size(self):
        return _conf.MapStringString_size(self)

    def swap(self, v):
        return _conf.MapStringString_swap(self, v)

    def begin(self):
        return _conf.MapStringString_begin(self)

    def end(self):
        return _conf.MapStringString_end(self)

    def rbegin(self):
        return _conf.MapStringString_rbegin(self)

    def rend(self):
        return _conf.MapStringString_rend(self)

    def clear(self):
        return _conf.MapStringString_clear(self)

    def get_allocator(self):
        return _conf.MapStringString_get_allocator(self)

    def count(self, x):
        return _conf.MapStringString_count(self, x)

    def erase(self, *args):
        return _conf.MapStringString_erase(self, *args)

    def find(self, x):
        return _conf.MapStringString_find(self, x)

    def lower_bound(self, x):
        return _conf.MapStringString_lower_bound(self, x)

    def upper_bound(self, x):
        return _conf.MapStringString_upper_bound(self, x)
    __swig_destroy__ = _conf.delete_MapStringString
    __del__ = lambda self: None
MapStringString_swigregister = _conf.MapStringString_swigregister
...
class StopIterator(_object):
    ...
    def __init__(self):
        this = _conf.new_StopIterator()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _conf.delete_StopIterator
    __del__ = lambda self: None
StopIterator_swigregister = _conf.StopIterator_swigregister
StopIterator_swigregister(StopIterator)

class OptionBinding(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, OptionBinding, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, OptionBinding, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _conf.new_OptionBinding(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def getPriority(self):
        return _conf.OptionBinding_getPriority(self)

    def newString(self, priority, value):
        return _conf.OptionBinding_newString(self, priority, value)

    def getValueString(self):
        return _conf.OptionBinding_getValueString(self)

    def getAddValue(self):
        return _conf.OptionBinding_getAddValue(self)
    __swig_destroy__ = _conf.delete_OptionBinding
    __del__ = lambda self: None
OptionBinding_swigregister = _conf.OptionBinding_swigregister
OptionBinding_swigregister(OptionBinding)
...
class OptionBinds(_object):
    ...
    def begin(self, *args):
        return _conf.OptionBinds_begin(self, *args)

    def cbegin(self):
        return _conf.OptionBinds_cbegin(self)

    def end(self, *args):
        return _conf.OptionBinds_end(self, *args)

    def cend(self):
        return _conf.OptionBinds_cend(self)

    def find(self, *args):
        return _conf.OptionBinds_find(self, *args)
...
class ConfigParser(_object):
    ...
    def setSubstitutions(self, *args):
        return _conf.ConfigParser_setSubstitutions(self, *args)
...
class MapStringMapStringString(_object):
    ...
    def iterator(self):
        return _conf.MapStringMapStringString_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _conf.MapStringMapStringString___nonzero__(self)

    def __bool__(self):
        return _conf.MapStringMapStringString___bool__(self)

    def __len__(self):
        return _conf.MapStringMapStringString___len__(self)
    def __iter__(self):
        return self.key_iterator()
    def iterkeys(self):
        return self.key_iterator()
    ...
    def __getitem__(self, key):
        return _conf.MapStringMapStringString___getitem__(self, key)

    def __delitem__(self, key):
        return _conf.MapStringMapStringString___delitem__(self, key)

    def has_key(self, key):
        return _conf.MapStringMapStringString_has_key(self, key)

    def keys(self):
        return _conf.MapStringMapStringString_keys(self)

    def values(self):
        return _conf.MapStringMapStringString_values(self)

    def items(self):
        return _conf.MapStringMapStringString_items(self)

    def __contains__(self, key):
        return _conf.MapStringMapStringString___contains__(self, key)

    def key_iterator(self):
        return _conf.MapStringMapStringString_key_iterator(self)

    def value_iterator(self):
        return _conf.MapStringMapStringString_value_iterator(self)

    def __setitem__(self, *args):
        return _conf.MapStringMapStringString___setitem__(self, *args)

    def asdict(self):
        return _conf.MapStringMapStringString_asdict(self)

    def __init__(self, *args):
        this = _conf.new_MapStringMapStringString(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def empty(self):
        return _conf.MapStringMapStringString_empty(self)

    def size(self):
        return _conf.MapStringMapStringString_size(self)

    def swap(self, v):
        return _conf.MapStringMapStringString_swap(self, v)

    def begin(self):
        return _conf.MapStringMapStringString_begin(self)

    def end(self):
        return _conf.MapStringMapStringString_end(self)

    def rbegin(self):
        return _conf.MapStringMapStringString_rbegin(self)

    def rend(self):
        return _conf.MapStringMapStringString_rend(self)

    def clear(self):
        return _conf.MapStringMapStringString_clear(self)

    def get_allocator(self):
        return _conf.MapStringMapStringString_get_allocator(self)

    def count(self, x):
        return _conf.MapStringMapStringString_count(self, x)

    def erase(self, *args):
        return _conf.MapStringMapStringString_erase(self, *args)

    def find(self, x):
        return _conf.MapStringMapStringString_find(self, x)

    def lower_bound(self, x):
        return _conf.MapStringMapStringString_lower_bound(self, x)

    def upper_bound(self, x):
        return _conf.MapStringMapStringString_upper_bound(self, x)
    __swig_destroy__ = _conf.delete_MapStringMapStringString
    __del__ = lambda self: None
MapStringMapStringString_swigregister = _conf.MapStringMapStringString_swigregister
MapStringMapStringString_swigregister(MapStringMapStringString)

class PairStringOptionBinding(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, PairStringOptionBinding, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, PairStringOptionBinding, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _conf.new_PairStringOptionBinding(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_setmethods__["first"] = _conf.PairStringOptionBinding_first_set
    __swig_getmethods__["first"] = _conf.PairStringOptionBinding_first_get
    if _newclass:
        first = _swig_property(_conf.PairStringOptionBinding_first_get, _conf.PairStringOptionBinding_first_set)
    __swig_setmethods__["second"] = _conf.PairStringOptionBinding_second_set
    __swig_getmethods__["second"] = _conf.PairStringOptionBinding_second_get
    if _newclass:
        second = _swig_property(_conf.PairStringOptionBinding_second_get, _conf.PairStringOptionBinding_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _conf.delete_PairStringOptionBinding
    __del__ = lambda self: None
PairStringOptionBinding_swigregister = _conf.PairStringOptionBinding_swigregister
PairStringOptionBinding_swigregister(PairStringOptionBinding)
